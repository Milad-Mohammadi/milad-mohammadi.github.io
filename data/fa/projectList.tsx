...
export const ProjectListFa: ProjectType[] = [
  ...
  },
  {
    ...
    technologies: [<AndroidSVG />],
    description:
      "اپلیکیشن پلاتینوم یک پلتفرم جستجوی املاک با امکانات متنوع است که قابلیت اتصال به API های املاک متعددی را داراست. پلاتینیوم دارای سرعت و قابلیت‌های سفارشی برندینگ است و می‌تواند مستقیماً به هر سایت IDX/MLS متصل شود و با روتر MLS یا WPL API یکپارچه شود. به علاوه، امکان اتصال به AWS برای انعطاف‌پذیری و مقیاس‌پذیری بیشتر نیز وجود دارد.&nbsp;&nbsp;برخی از ویژگی‌های منحصربه‌فرد برنامه Platinum عبارتند از:&nbsp;- افزایش سرعت و رابط کاربری نرم‌تر&nbsp;- حالت تاریک&nbsp;- Cashing ویژه سیستم&nbsp;- گزینه ای برای نمایش آخرین املاک مشاهده شده&nbsp;- تغییر آسان ارائه دهنده&nbsp;- احراز هویت ایمن با خدمات وب آمازون (AWS)",
    githubUrl: "",
    websiteUrl:
  ...
  },
  {
    ...
    technologies: [<AndroidSVG />],
    description:
      "این برنامه تحت لیسانس شرکت Realtyna و به صورت کامل توسط بنده پیاده‌سازی شده است. امکانات بسیار زیادی از جمله نقشه قابل جستجو، فیلتر پیشرفته جستجو، امکان رسم شکل روی نقشه برای محدود کردن جستجو، ذخیره جستجوها و ارتباط با مشاور املاک در آن پیاده‌سازی شده است.",
    githubUrl: "",
    websiteUrl:
  ...
  },
  {
    ...
    technologies: [<AndroidSVG />],
    description:
      "کاملترین و زیباترین نرم‌افزار حسابداری فروشگاهی ایران با امتیاز ۴.۲ از ۵ در کافه‌بازا. این نرم‌افزار در تاریخ ۹ تیر ۱۴۰۱ در صفحه اصلی کافه‌بازار به عنوان برنامه منتخب نمایش داده شد. در طراحی رابط کاربری و پیاده‌سازی این پروژه سعی کردم تمامی امکانات مورد نیاز یک نرم‌افزار حسابداری فروشگاهی پیشرفته را در ساده‌ترین قالب ممکن ارائه دهم. استفاده از متد FIFO، رابط کاربری روان و نمودارهای زیبا بعضی از مزیت‌های این نرم‌افزار نسبت به رقبا هستند. ",
    githubUrl: "",
  ...
  },
  {
    ...
    technologies: [<AndroidSVG />],
    description:
      "این برنامه یک برنامه برای نمایش اطلاعات بازار سهام است که با معماری Clean که با Jetpack Compose، Caching و SOLID اجرا شده است. این برنامه یک پیاده‌سازی ساده از Jetpack Compose است و یک تولید واقعی نیست. می‌توانید آن را در پروفایل GitHub من بررسی کنید.",
  ...
  },
  {
    ...
    technologies: [<AndroidSVG />],
    description:
      "اپلیکیشن کافینو به سفارش یک کافی‌شاپ در تابستان ۱۳۹۸ طراحی و پیاده‌سازی شد. این اپلیکیشن روی تبلت و موبایل ویتر یا گارسون نصب شده و برای دریافت، ثبت و مدیریت سفارشات و حذف یادداشت سفارشات در نرم‌افزار یا کاغذ استاده می‌شود. در این نرم‌افزار از دیتابیس داخلی SQLite و کتابخانه Room برای ذخیره‌سازی اطلاعات استفاده شده است و همه‌ی اطلاعات به صورت محلی روی دستگاه کاربر ذخیره می‌شوند.",
    githubUrl: "",
    websiteUrl: "",
